# Workflow: dpl-ingestion-activity-staging

## Overview

**Type:** Batch  
**Entity:** activity-staging  
**Purpose:** Scheduled batch ingestion of activity-staging data from CosmosDB to bronze and silver layers

---

## Configuration

**Workflow Name:** dpl-ingestion-activity-staging  
...
```
CosmosDB (activity-staging collection)
  → run_ingestion
  → activity-staging.py (entity class inherits from BaseTable)
  → frt_am.bronze_Platform.activitystaging
  → frt_am.silver_Platform.activitystaging_harmonized (via SCD2)
```
...
**Class:** activity-staging  
**Parent:** BaseTable  
**Location:** hdl/process/tables/activity-staging.py
...
- activity-staging Entity: `hdl_activity-staging.md`
...
**Source:** workflow_hdl/dpl-ingestion-activity-staging.json
