# Workflow: dpl-stream-visits-sched

## Overview

**Type:** Streaming  
**Entity:** visits-sched  
**Purpose:** Real-time ingestion and processing of visits-sched data from Event Hub to silver layer

---

## Configuration

**Workflow Name:** dpl-stream-visits-sched  
...
**Type:** file_arrival  
**Event Hub Path:** `<EVENTHUB_BASE_PATH>evh<ENVIRONMENT>am-ldz012-Operations-Platform-visits-sched/`  
...
**Parameters:**
- `event_hub_entity_name`: visits-sched
- `table_name`: frt_am.bronze_Platform.user_sessions__visits_sched_stream
...
**Notebook:** `/Workspace/Shared/hdl_stm/layers/silver/visits_sched`  
**Cluster:** CLUSTER_MEMORY_OPTIMIZED_SMALL  
**Timeout:** No limit (streaming continuous)
...
```
Event Hub (visits-sched) 
  → bronze_ingestion.py 
  → frt_am.bronze_Platform.user_sessions__visits_sched_stream
  → visits_sched (silver processing)
  → frt_am.bronze_Platform.user_sessions__visits_sched_stream_harmonized
```
...
- Silver Processing: `hdl_stm/layers/silver/visits-sched.py`
- Entity Documentation: `hdl_Sessions-Sched.md`
- Streaming Architecture: `DPL_COMPLETE_KNOWLEDGE.md`

---

**Last Updated:** 2025-10-05  
**Source:** workflow_hdl/dpl-stream-visits-sched.json
