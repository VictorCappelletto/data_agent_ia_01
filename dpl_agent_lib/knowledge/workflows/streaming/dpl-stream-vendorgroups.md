# Workflow: dpl-stream-vendorgroups

## Overview

**Type:** Streaming  
**Entity:** vendorgroups  
**Purpose:** Real-time ingestion and processing of vendorgroups data from Event Hub to silver layer

---

## Configuration

**Workflow Name:** dpl-stream-vendorgroups  
...
**Type:** file_arrival  
**Event Hub Path:** `<EVENTHUB_BASE_PATH>evh<ENVIRONMENT>am-ldz012-Operations-Platform-vendorgroups/`  
...
**Parameters:**
- `event_hub_entity_name`: vendorgroups
- `table_name`: frt_am.bronze_Platform.vendorgroups__treenodes_stream
...
**Notebook:** `/Workspace/Shared/hdl_stm/layers/silver/vendorgroups`  
**Cluster:** CLUSTER_MEMORY_OPTIMIZED_SMALL  
**Timeout:** No limit (streaming continuous)
...
```
Event Hub (vendorgroups) 
  → bronze_ingestion.py 
  → frt_am.bronze_Platform.vendorgroups__treenodes_stream
  → vendorgroups (silver processing)
  → frt_am.bronze_Platform.vendorgroups__treenodes_stream_harmonized
```
...
- Silver Processing: `hdl_stm/layers/silver/vendorgroups.py`
- Entity Documentation: `hdl_Vendorgroups.md`
- Streaming Architecture: `DPL_COMPLETE_KNOWLEDGE.md`

---

**Last Updated:** 2025-10-05  
**Source:** workflow_hdl/dpl-stream-vendorgroups.json
