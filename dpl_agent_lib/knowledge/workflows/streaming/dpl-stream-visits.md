# Workflow: dpl-stream-visits

## Overview

**Type:** Streaming  
**Entity:** visits  
**Purpose:** Real-time ingestion and processing of visits data from Event Hub to silver layer

---

## Configuration

**Workflow Name:** dpl-stream-visits  
...
**Type:** file_arrival  
**Event Hub Path:** `<EVENTHUB_BASE_PATH>evh<ENVIRONMENT>am-ldz012-Operations-Platform-visits/`  
...
**Parameters:**
- `event_hub_entity_name`: visits
- `table_name`: frt_am.bronze_Platform.user_sessions__visits_stream
...
**Notebook:** `/Workspace/Shared/hdl_stm/layers/silver/visits`  
**Cluster:** CLUSTER_MEMORY_OPTIMIZED_SMALL  
**Timeout:** No limit (streaming continuous)
...
Event Hub (visits) 
  → bronze_ingestion.py 
  → frt_am.bronze_Platform.user_sessions__visits_stream
  → visits (silver processing)
  → frt_am.bronze_Platform.user_sessions__visits_stream_harmonized
```
...
- Silver Processing: `hdl_stm/layers/silver/visits.py`
- Entity Documentation: `hdl_Sessions.md`
- Streaming Architecture: `DPL_COMPLETE_KNOWLEDGE.md`

---

**Last Updated:** 2025-10-05  
**Source:** workflow_hdl/dpl-stream-visits.json
