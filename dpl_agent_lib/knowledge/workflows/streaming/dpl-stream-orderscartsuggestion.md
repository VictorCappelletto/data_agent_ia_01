# Workflow: dpl-stream-orderscartsuggestion

## Overview

**Type:** Streaming  
**Entity:** orderscartsuggestion  
**Purpose:** Real-time ingestion and processing of orderscartsuggestion data from Event Hub to silver layer

---

## Configuration

**Workflow Name:** dpl-stream-orderscartsuggestion  
...
**Type:** file_arrival  
**Event Hub Path:** `<EVENTHUB_BASE_PATH>evh<ENVIRONMENT>am-ldz012-Operations-Platform-pre-orders/`  
...
**Parameters:**
- `event_hub_entity_name`: pre-orders
- `table_name`: frt_am.bronze_Platform.orders__orderscartsuggestion_stream
...
**Notebook:** `/Workspace/Shared/hdl_stm/layers/silver/pre_orders`  
**Cluster:** CLUSTER_MEMORY_OPTIMIZED_SMALL  
**Timeout:** No limit (streaming continuous)
...
```
Event Hub (orderscartsuggestion) 
  → bronze_ingestion.py 
  → frt_am.bronze_Platform.orders__orderscartsuggestion_stream
  → pre_orders (silver processing)
  → frt_am.bronze_Platform.orders__orderscartsuggestion_stream_harmonized
```
...
- Silver Processing: `hdl_stm/layers/silver/orderscartsuggestion.py`
- Entity Documentation: `hdl_Orderscartsuggestion.md`
- Streaming Architecture: `DPL_COMPLETE_KNOWLEDGE.md`

---

**Last Updated:** 2025-10-05  
**Source:** workflow_hdl/dpl-stream-orderscartsuggestion.json
