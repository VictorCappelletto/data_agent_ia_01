# Workflow: dpl-stream-visits-sched-hist

## Overview

**Type:** Streaming  
**Entity:** visits-sched-hist  
**Purpose:** Real-time ingestion and processing of visits-sched-hist data from Event Hub to silver layer

---

## Configuration

**Workflow Name:** dpl-stream-visits-sched-hist  
...
**Type:** file_arrival  
**Event Hub Path:** `<EVENTHUB_BASE_PATH>evh<ENVIRONMENT>am-ldz012-Operations-Platform-visits-sched-hist/`  
...
**Parameters:**
- `event_hub_entity_name`: visits-sched-hist
- `table_name`: frt_am.bronze_Platform.user_sessions__visits_sched_hist_stream
...
**Notebook:** `/Workspace/Shared/hdl_stm/layers/silver/visits_sched_hist`  
**Cluster:** CLUSTER_MEMORY_OPTIMIZED_SMALL  
**Timeout:** No limit (streaming continuous)
...
```
Event Hub (visits-sched-hist) 
  → bronze_ingestion.py 
  → frt_am.bronze_Platform.user_sessions__visits_sched_hist_stream
  → visits_sched_hist (silver processing)
  → frt_am.bronze_Platform.user_sessions__visits_sched_hist_stream_harmonized
```
...
- Silver Processing: `hdl_stm/layers/silver/visits-sched-hist.py`
- Entity Documentation: `hdl_Sessions-Sched-Hist.md`
- Streaming Architecture: `DPL_COMPLETE_KNOWLEDGE.md`

---

**Last Updated:** 2025-10-05  
**Source:** workflow_hdl/dpl-stream-visits-sched-hist.json
